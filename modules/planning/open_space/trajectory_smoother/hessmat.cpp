...
int main() {
  ...
  for (i = 0; i <= d; i++) {
    printf(" d = %d \n", i);
    for (j = 0; j < n; j++) printf(" %6.3f ", Zpp[j][i]);
    printf("\n");
  }
  ...
  for (l = 0; l < q; l++) {
    for (i = 0; i <= d; i++) {
      printf(" d = %d \n", i);
      for (j = 0; j < n; j++) printf(" %6.3f ", Zppp[l][j][i]);
      printf("\n");
    }
    printf("\n\n");
  }
  ...
  if (m == 1) {
    ...
    for (i = 0; i < q; i++) {
      for (j = 0; j < n; j++) printf(" %6.3f ", W[i][j]);
      printf("\n");
    }
    printf("hessian2:\n");
    hessian2(1, n, xp, H);
    for (i = 0; i < n; i++) {
      for (j = 0; j < n; j++) printf(" %6.3f ", H[i][j]);
      printf("\n");
    }
  }
