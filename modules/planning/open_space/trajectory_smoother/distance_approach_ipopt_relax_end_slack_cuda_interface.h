...
class DistanceApproachIPOPTRelaxEndSlackCudaInterface
    : public DistanceApproachInterface {
 public:
  explicit DistanceApproachIPOPTRelaxEndSlackCudaInterface(
      const size_t horizon, const double ts, const Eigen::MatrixXd& ego,
      const Eigen::MatrixXd& xWS, const Eigen::MatrixXd& uWS,
      const Eigen::MatrixXd&  , const Eigen::MatrixXd& n_warm_up,
  ...
  virtual ~DistanceApproachIPOPTRelaxEndSlackCudaInterface() = default;
